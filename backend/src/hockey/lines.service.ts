...
export class LinesService {
  constructor(
    ...
    private footballRepository: Repository<Hockey>,
  ) {}
  ...
  async addLines(objLinesIncomming: any) {
    console.log('Hockey Lines arrLines', objLinesIncomming.arrLines[1]);
    ...
    return 'Hockey Lines Ok';
  }

  // === Для отладки
  async addOneLine(objLinesIncomming: LinesDto) {
    console.log('Hockey One Lines objLinesIncomming', objLinesIncomming);
